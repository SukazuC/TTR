...
std::span<const ModuleIdentityV1> RecordModules(const ManifestView&,
                                                const ManifestRecordV1&) noexcept;
std::span<const ManifestSymbolV1> RecordSymbols(const ManifestView&,
                                                const ManifestRecordV1&) noexcept;
...
const ManifestRecordV1* SelectExactRecord(const ManifestView&, std::span<const ModuleIdentityV1>,
